...
%%%%% scenarios applying f biota values in only vegetated part of grid

%SCENARIO 0.6- excluded from PWA calibration
%f_biota_past = (0.6 .* f_biota) .* plants_past ;
%f_biota_future = (0.6 .* f_biota) .* plants_future ;
...
%SCENARIO 1  - best fit when PREPANT = 1/3
...
%SCENARIO 1.4 - excluded from PWA calibration
%f_biota_past = (1.4 .* f_biota) .* plants_past ;
%f_biota_future = (1.4 .* f_biota) .* plants_future ;
